"""Lightweight tests for log2timeline TASK_METADATA wiring.

Importing src.log2timeline at runtime is expensive (it iterates all plaso
parsers) and requires plaso to be installed. We avoid the full import here
and instead assert the new register_in_db switch is declared in source —
plus verify by stubbed-import that the metadata dict has the new entry.
"""
